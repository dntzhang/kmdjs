define("SysMenu:cc.Layer", {
    ...
    init: function (aa) {
        var bRet = false, res = Resource.res;
        if (this._super()) {
    ...
    onNewGame: function (pSender) {
        //load resources
        cc.LoaderScene.preload(Resource.g_maingame, function () {
    ...
    update: function () {
        if (this._ship.y > 480) {
            ...
            this._ship.runAction(cc.MoveBy.create(
                ...
                cc.p(Math.random() * this.winSize.width, this._ship.y + 480)));
        }
    },
