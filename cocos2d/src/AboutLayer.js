define("AboutLayer:cc.Layer", {
    ...
    init: function () {
        ...
        if (this._super()) {
            ...
            var sp = cc.Sprite.create(Resource.res.loading_png);
            sp.anchorX = 0;
            sp.anchorY = 0;
            this.addChild(sp, 0, 1);

            var cacheImage = cc.textureCache.addImage(Resource.res.menuTitle_png);
